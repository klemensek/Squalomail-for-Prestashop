 ...
 */
class AdminSqualomailModuleBatchesController extends \PrestaChamps\SqualomailModule\Controllers\BaseSQMObjectController
{
            ...
            foreach (new RecursiveIteratorIterator($it) as $file) {
                if ($file->getExtension() === 'json') {
                    ...
                    foreach ($items as $item) {
                        $responses[] = \PrestaChamps\SqualomailModule\Models\BatchResponse::fromArray($item);
                    }
                }
            }
