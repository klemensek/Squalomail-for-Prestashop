...
<div id="setup-wizard">
    <ul>
        ...
        <li>
            <a href="#step-3">
                {l s='Order status mapping' mod='squalomailmodule'}
            </a>
        </li>
        <li>
            <a href="#step-4">
                {l s='Shop sync' mod='squalomailmodule'}
            </a>
        </li>
        <li>
            <a href="#step-5">
                {l s='Product sync' mod='squalomailmodule'}
            </a>
        </li>        
        <li>
            <a href="#step-6">
                {l s='Customer sync' mod='squalomailmodule'}
            </a>
        </li>
        <li>
            <a href="#step-7">
                {l s='promo-code sync' mod='squalomailmodule'}
            </a>
        </li>
        <li>
            <a href="#step-8">
                {l s='Order sync' mod='squalomailmodule'}
            </a>
        </li>
        <li>
            <a href="#step-9">
                {l s='Category sync' mod='squalomailmodule'}
            </a>
        </li>
    </ul>
    ...
    <div>
        ...
        <div id="step-9" class="text-center">
            {include file="./wizard/step-9.tpl"}
        </div>
    </div>
</div>